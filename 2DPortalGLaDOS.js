...
//flip chell with alternate image
...
function info(){
    ...
    keyDownMethod(stageOne);
    //keyDownMethod(stageGLaDOS);
}
...
function stageOne(){
    ...
    portalWall2.setPosition(325, 10);
    add(portalWall2);
...
function stageThree(){
    ...
    portalWall2 = new WebImage("https://codehs.com/uploads/b01ab623a7fe8558664430c5240f4cc8");
    portalWall2.setSize(50, 100);
    portalWall2.setPosition(350, 200);
    add(portalWall2);
    
    add(chell);
}

function stageGLaDOS(){
    ...
    GLaDOS = new WebImage("https://codehs.com/uploads/902db661a9feaf48d9b08a569749e31e");
    GLaDOS.setSize(100, 230);
    GLaDOS.setPosition(getWidth()/2 - GLaDOS.getWidth()/4*3, 0);
    add(GLaDOS);
    
    GLaDOSHeart1 = new WebImage("https://codehs.com/uploads/7739c22d0ccbda6f440a22948fa3b560");
    GLaDOSHeart1.setSize(25, 25);
    GLaDOSHeart1.setPosition(0, 0);
    add(GLaDOSHeart1);
    
    GLaDOSHeart2 = new WebImage("https://codehs.com/uploads/7739c22d0ccbda6f440a22948fa3b560");
    GLaDOSHeart2.setSize(25, 25);
    GLaDOSHeart2.setPosition(25, 0);
    add(GLaDOSHeart2);
    
    GLaDOSHeart3 = new WebImage("https://codehs.com/uploads/7739c22d0ccbda6f440a22948fa3b560");
    GLaDOSHeart3.setSize(25, 25);
    GLaDOSHeart3.setPosition(50, 0);
    add(GLaDOSHeart3);
    
    GLaDOSHeart4 = new WebImage("https://codehs.com/uploads/7739c22d0ccbda6f440a22948fa3b560");
    GLaDOSHeart4.setSize(25, 25);
    GLaDOSHeart4.setPosition(75, 0);
    add(GLaDOSHeart4);
    
    GLaDOSHeart5 = new WebImage("https://codehs.com/uploads/7739c22d0ccbda6f440a22948fa3b560");
    GLaDOSHeart5.setSize(25, 25);
    GLaDOSHeart5.setPosition(100, 0);
    add(GLaDOSHeart5);
    ...
    setTimer(nextLVL, 1);
    setTimer(checkLazer, 1);
    setTimer(moveGLaDOS, 1000);
    setTimer(setGLaDOS, 1000);
    setTimer(chellDead, 100);
    
    keyDownMethod(movement);
    keyUpMethod(antiMovement);
    mouseMoveMethod(gunAngle);
    mouseClickMethod(GLaDOSDamage);
    
    platformer = platform(50, 10, 175, 320);
    platformer = platform(50, 10, 87, 350);
    platformer = platform(50, 10, 262, 350);
    
    portalWall1 = new WebImage("https://codehs.com/uploads/b01ab623a7fe8558664430c5240f4cc8");
    portalWall1.setSize(50, 100);
    portalWall1.setPosition(25, 250);
    add(portalWall1);
    
    portalWall2 = new WebImage("https://codehs.com/uploads/b01ab623a7fe8558664430c5240f4cc8");
    portalWall2.setSize(50, 100);
    portalWall2.setPosition(325, 250);
    add(portalWall2);
...
//how to damage GLaDOS
function GLaDOSDamage(e){
    var mouseDamage = getElementAt(e.getX, e.getY);
    println("test.3");
    
    if (mouseDamage == GLaDOS){
        b++;
        println("test.1");
        if (b = 1){
            remove(GLaDOSHeart1);
